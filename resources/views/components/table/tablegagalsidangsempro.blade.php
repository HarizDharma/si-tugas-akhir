    ...
    <div class="p-4 rounded-lg mt-14 bg-gray-50">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                Data Mahasiswa Yang Gagal Sidang Sempro
                <div class="text-left text-sm">
                    <p>Catatan : Disini data mahasiswa yang gagal sidang sempro dan mengulangi</p>
                </div>
            </caption>
            ...
            @foreach ($mahasiswa as $datamahasiswa)
                ...
                @if($datamahasiswa['mahasiswa_id']['status_id']['nama_status'] == 'Sudah Sidang Sempro dan Mengulangi')
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @elseif($datamahasiswa['mahasiswa_id']['verifikasi_id']['verifikasi_panitia_sempro'] !== null)
