    ...
    <div class="p-4 rounded-lg mt-14 bg-gray-50">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                Data Mahasiswa Yang Gagal Sidang Akhir
                <div class="text-left text-sm">
                    <p>Catatan : Disini data mahasiswa yang gagal sidang dan mengulangi serta mengubah hasil sidang akhir</p>
                </div>
            </caption>
...
{{--                            panggil modal detail mahasiswa component--}}
                            ...
                            <x-modal.ubahhasilsidangakhir :datamahasiswa="$datamahasiswa" />
