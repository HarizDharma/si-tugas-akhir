    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambah Hasil Sidang Mahasiswa</h3>
                <form class="space-y-6" action="{{ route('tambahHasilSidangMahasiswa', ['id' => $datamahasiswa['id']]) }}" method="POST">
                    @csrf
                    <div>
