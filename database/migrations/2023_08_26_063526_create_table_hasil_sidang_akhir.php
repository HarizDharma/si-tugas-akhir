...
class CreateTableHasilSidangAkhir extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('table_hasil_sidang_akhir', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('table_hasil_sidang_akhir');
    }
}
